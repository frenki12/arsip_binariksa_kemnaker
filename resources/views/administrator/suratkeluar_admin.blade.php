    ...
    <div class="content p-4" id="content">
        ...
        <div class="header-content d-flex justify-content-between align-items-center shadow-sm">
            <div class="d-flex align-items-center">
                ...
                <h4 class="mb-0 fw-bold">SURAT KELUAR</h4>
            </div>
            <div class="d-flex align-items-center">
        ...
        <div class="d-flex justify-content-between align-items-center mb-3 flex-wrap gap-2">
            <!-- Judul -->
            <div>
                <h5 class="fw-bold mb-1">Dokumen Surat Keluar</h5>
        ...
        <div class="card card-stat p-3 mt-4">
            <h6 class="mb-3">Daftar Surat Keluar</h6>
                ...
                <table class="table table-bordered align-middle text-center">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td><a href="#" class="text-primary text-decoration-none">Lihat</a></td>
                            <td><span class="text-success">✓ Dalam Folder</span><br><small>CV Sejahtera -
                                    HUBKER</small>
                            </td>
                        ...
                        <tr>
                            ...
                            <td>Peraturan No. 5/2024</td>
                            <td><a href="#" class="text-primary text-decoration-none">Lihat</a></td>
                            <td><span class="text-success">✓ Dalam Folder</span><br><small>PT Maju Jaya - K3</small>
                            </td>
