    ...
    <div class="content p-4" id="content">
        ...
        <div class="header-content d-flex justify-content-between align-items-center shadow-sm">
            <div class="d-flex align-items-center">
                ...
                <h4 class="mb-0 fw-bold">DOKUMEN WKWI</h4>
            </div>
            <div class="d-flex align-items-center">
        ...
        <div class="d-flex justify-content-between align-items-center mb-3 flex-wrap gap-2">
            <!-- Judul -->
            <div>
                <h5 class="fw-bold mb-1">Dokumen Surat WKWI</h5>
            ...
            <div class="modal-dialog modal-lg">
                <div class="modal-content">
                    ...
                    <form action="{{ route('arsip.store') }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        <input type="hidden" name="divisi" value="wkwi">
        ...
        <div class="table-scroll-wrapper">
            <table class="table table-bordered align-middle text-center">
                ...
                <tbody>
                    @forelse ($arsip->where('divisi', 'WKWI') as $item)
                        <tr>
